...
config = {
    ...
    "use_mtcnn": 1, # The author already cropped the faces, no need to do it ourselves.
    "load_cropped_aligned_facial_image": 0, # Therefore we load them directly.
    ...
    "CMU-MOSEI_label_cols": ["sentiment", "happy", "sad", "anger", "surprise", "disgust", "fear"],
    ...
    "align_word_embedding": 0, # Finally populate the bert feature according to the timestamps
    "aligned_word_embedding_folder": "aligned_word_embedding",

    "save_npy": 0, # Save all extracted feature to npy
    ...
    "speech_model": {
        ...
        "path": "/data1/9th-ABAW/preprocessing/load/vosk-model-en-us-0.22"
    },
}
