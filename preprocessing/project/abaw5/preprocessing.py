...
class PreprocessingABAW5(GenericVideoPreprocessing):
    def __init__(self, part, config, cnn_path=None):
        ...
        self.partition_list = ["train", "valid", "test"]
    ...
    def generate_task_trial_list(self):
        ...
        for partition in self.partition_list:
            if partition == "train" or partition == "valid":
                label_path = os.path.join(self.config['root_directory'], 'merged_label.csv')
    ...
    def generate_iterator(self):
        train_trial_list = self.trial_list[self.task]['train']
    ...
    def generate_per_trial_info_dict(self):
        ...
        if os.path.isfile(per_trial_info_path):
            ...
            for idx, file in pbar:
                ...
                this_trial['trial'] = file.split('/')[-2] + "_" + file.split('/')[-1].split('.')[0]
                ...
                this_trial['video_path'] = this_trial['audio_path'] = file
                ...
                continuous_label = self.load_continuous_label(**load_continuous_label_kwargs)
    ...
    def load_continuous_label(self, path='/data1/9th-ABAW/agi/merged_label.csv', **kwargs):
    ...
    def process_continuous_label(self, continuous_label, **kwargs):
        ...
        annotated_index = np.asarray(range(len(continuous_label)))
