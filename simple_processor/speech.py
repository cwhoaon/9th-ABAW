...
def extract_transcript(input_path, data_path, data_name, model, KaldiRecognizer):

    output_path = os.path.join(data_path, data_name, "transcript.csv")

    if os.path.isfile(output_path):
        print("Transcript already exists, skipping extraction.")
        return output_path
